...
import 'package:uts_mobile/view/login.dart';
...
class _RegisterState extends State<Register> {
  ...
  void register(String email, password) async {
    try {
      ...
      var response = await Dio().post('http://192.168.50.26:3000/user',
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  primary: Color.fromARGB(255, 222, 97, 172),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text("Sign in",
                      style: TextStyle(
                        fontSize: 16,
                        color: Color.fromARGB(255, 209, 103, 206),
                      )),
                ),
              ],
            ),
